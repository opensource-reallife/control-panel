...
export default class PrisonDialog extends Component {
    constructor() {
        super();
        this.state = {
            show: false,
    ...
    render() {
        return (
            <>
                <span className="dropdown-item" style={{'cursor': 'pointer'}} onClick={this.handleShow}>ins Prison</span>

                <Modal show={this.state.show} onHide={this.handleClose}>
                    <Modal.Header closeButton>
                        <Modal.Title>{this.props.name} ins Prison stecken</Modal.Title>
                    </Modal.Header>
                    <Modal.Body>
                        <Form>
                            <Form.Group>
                    ...
                    <Modal.Footer>
                        <Button variant="danger" onClick={this.prison.bind(this)}>
                            ins Prison
                        </Button>
...
var prisonDialogs = document.getElementsByTagName('react-prison-dialog');

for (var index in prisonDialogs) {
