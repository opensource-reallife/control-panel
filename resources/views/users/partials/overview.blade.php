        ...
        <div class="col-md-2">
            <div class="card">
                <div class="card-body">
                    <dl class="user-stats">
                        <dt>Gebannt</dt>
                        <dd>@if($banned === false)<i class="fas fa-times text-red-500"></i>@else @if($banned === 0)<i class="fas fa-check text-green-500"></i>@else{{ (new \DateTime)->setTimestamp($banned)->format('d.m.Y H:i:s') }}@endif @endif</dd>
