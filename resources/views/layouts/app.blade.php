    ...
    <div id="app" class="c-wrapper">
                    ...
                    @else
                        <li class="c-header-nav-item dropdown px-3">
                            <a class="c-header-nav-link" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
                                <div class="c-avatar"><img class="c-avatar-img" src="https://ingame.openreallife.net/images/skins_head/{{ Auth::user()->character->Skin ?? 0 }}.png" alt="{{ Auth::user()->Name }}"></div>
                            </a>
        ...
        @if(!request()->exists('minimal'))
            <footer class="c-footer">
                ...
                <div class="mfs-auto">{{ __('Release: :version', ['version' => substr(config('sentry.release'), 0, 8)]) }}</div>
            </footer>
        @endif
    </div>
